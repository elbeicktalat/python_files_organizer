...
ALL_DESTINATION_DIRECTORIES = [
    DESTINATION_DIRECTORY_MUSIC,
    DESTINATION_DIRECTORY_VIDEO,
    DESTINATION_DIRECTORY_IMAGE,
    ACCESS_DESTINATION_DIRECTORY,
    EXCEL_DESTINATION_DIRECTORY,
    WORD_DESTINATION_DIRECTORY,
    POWER_POINT_DESTINATION_DIRECTORY,
    PDF_DESTINATION_DIRECTORY,
    TEXT_DESTINATION_DIRECTORY,
    COMPRESSED_FILE_DESTINATION_DIRECTORY,
    INSTALLATION_APPLICATION_DESTINATION_DIRECTORY
]
